...
from elementum.util import notify, system_information, getLocalizedString, getWindowsShortPath
...
def get_elementum_binary():
    ...
    if not os.path.exists(dest_binary_path) or get_elementumd_checksum(dest_binary_path) != get_elementumd_checksum(binary_path):
    ...
    log.info("Get Binary detection: %s, %s" % (dest_binary_dir, dest_binary_path))
                    ...
                    try:
                        ...
                        for ro in to_read:
                            ...
                            if line == "":  # write end is closed
                                break
                            log.info("elementumd: proc.poll line" + line)
                    except IOError:
